...
import MidBar from "@/components/contentLeft/MidBar.vue";
...
export default {
	...
	methods: {
		...
		yunyingReq() {
			...
			this.lineOneData = {
				dataValue: [
					91555255, 92515205, 93545255, 94135255, 95555255, 98555255, 100202120,
				],
				xLabel: [
					"2022/10/02",
					"2022/10/03",
			...
			this.lineTwoData = {
				dataValue: [
					3989552, 3865865, 3544555, 3255455, 3214124, 3122560, 3000000,
				],
				xLabel: [
					"2022/9/02",
					"2022/9/03",
			...
			this.lineThreeData = {
				dataValue: [12202, 12522, 15888, 13235, 24585, 19000, 16666],
				xLabel: [
					"2022/10/02",
					"2022/10/03",
					"2022/10/04",
		...
		async jiFenReq() {
			...
			this.addPoint = [
				Number(res.bzxz["v"]).toLocaleString(),
				Number(res.szxz["v"]).toLocaleString(),
			];
